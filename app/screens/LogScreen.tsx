...
const GROUPS: Record<Exclude<Filter, 'all'>, readonly EventType[]> = {
  ...
  jobs: ['OP_STARTED', 'OP_RESOLVED', 'OFFERS_REFRESHED', 'TRAINING_DONE', 'CREW_STAT_UP', 'CREW_RANK_UP', 'PERK_CHOSEN','RECRUITED', 'FIRED', 'RAISED', 'CREW_SLOT_BOUGHT', 'POOL_REFRESHED', 'ENFORCER_ASSIGNED', 'ENFORCER_REMOVED', 'WALKOUT', 'RELEASED', 'ARREST', 'WAGES_PAID', 'WAGES_MISSED'],
  ...
  money: ['COLLECTED', 'DEPOSITED', 'FRONT_MODE_SET', 'UPKEEP_PAID', 'UPKEEP_MISSED', 'STOCK_OUT', 'STOCK_CAPPED', 'SHORTAGE_STARTED', 'SHORTAGE_ENDED', 'RACKET_BOUGHT', 'RACKET_UPGRADED', 'RACKET_REPAIRED', 'FRONT_BOUGHT', 'FRONT_UPGRADED', 'VAULT_CAPPED', 'OFFLINE_CAPPED'],
}
