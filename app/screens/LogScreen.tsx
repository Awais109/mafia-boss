...
const GROUPS: Record<Exclude<Filter, 'all'>, readonly EventType[]> = {
  ...
  turf: ['TOLYA_TICK', 'TRIBUTE_PAID', 'TRIBUTE_HAGGLED', 'SHIPMENT_BOUGHT', 'SURPLUS_SOLD', 'TRIBUTE_REFUSED', 'DISTRICT_BOUGHT', 'DISTRICT_PRESSURED', 'DISTRICT_FLIPPED', 'NOTE'],
  money: ['COLLECTED', 'DEPOSITED', 'FRONT_MODE_SET', 'UPKEEP_PAID', 'UPKEEP_MISSED', 'STOCK_OUT', 'STOCK_CAPPED', 'SHORTAGE_STARTED', 'SHORTAGE_ENDED', 'GOLD_GRANTED', 'TIME_SKIPPED', 'GOAL_DONE', 'RACKET_BOUGHT', 'RACKET_UPGRADED', 'RACKET_REPAIRED', 'FRONT_BOUGHT', 'FRONT_UPGRADED', 'VAULT_CAPPED', 'OFFLINE_CAPPED'],
}
