...
| `tests/migrate.test.ts` | A schema 1 save migrates through every step (inbox, board, ledger; crew progress, front dials, haggle state; stock, upkeep, Station Square), keeps old stats, and keeps playing; a save from a newer build is refused |
